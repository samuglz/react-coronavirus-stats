...
//          <ul>
//             <li>
//                <button onClick={incrementConfirm}>
//                   {/* Confirmados ({appStore.confirmadas.length}) ++ */}
//                </button>
//             </li>
//             <li>
//                <button onClick={incrementDeaths}>
//                   {/* Muertes ({appStore.muertes}) ++ */}
//                </button>
//             </li>
//             <li>
//                {/* <button onClick={incrementRecuperados}>
//                   Recuperados ({appStore.recuperados}) ++
//                </button> */}
//             </li>
//             <li>
...
//          {/* <ul>
//             {appStore.confirmadas.map(confirmado => (
//                <li
//                   key={confirmado.id}
//                   onClick={() => {
...
//                   }}
//                >
//                   {confirmado.name}-{confirmado.temperatura}
//                </li>
//             ))}
//          </ul> */}
//          {/*<Hijo/>*/}
